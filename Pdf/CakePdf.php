 ...
 */
	public function __construct($config = array()) {
  	...
  	if (!empty($config['coversheet'])) {
			$this->coverSheet = $config['coversheet'];
		}
 ...
 * @return string
 */
	public function outputWithCoverSheet($coversheet, $html = null) {
		$Engine = $this->engine();
		if (!$Engine) {
			throw new CakeException(__d('cake_pdf', 'Engine is not loaded'));
		}
    ...
    $output = $Engine->coverSheet($coversheet);
